...
% The papers covered in this sections included strategies have
% been trained using generic strategy archetypes based on lookup tables, neural
% networks finite state machines etc arriving at particularly effective parameter
% choices through evolutionary or particle swarm algorithms.
