...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%PARAMETERS%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\totalarticles}{\input{total_articles.txt}}
\newcommand{\manual}{\input{prov_manual.txt}}
\newcommand{\authors}{\input{number_of_authors.txt}}
\newcommand{\edges}{\input{num_Edges.txt}\unskip}
\newcommand{\isolated}{\input{num_Isolated_nodes.txt}}
\newcommand{\isolatedpercentage}{\input{perce_Isolated_nodes.txt}}
\newcommand{\connectedcomponents}{\input{num_Connected_components.txt}}
\newcommand{\communities}{\input{num_Communities.txt}}
\newcommand{\largestcc}{\input{Size_of_largest_component.txt}}
\newcommand{\clustering}{\input{Clustering_coeff.txt}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[H]
    \centering
    \resizebox{\textwidth}{!}{
    \input{topic_network_comparison.tex}}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{.9\textwidth}{!}{\input{centralities_pd_graph.tex}}
\end{center}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{.9\textwidth}{!}{\input{betweeness_topics_graphs.tex}}
\end{center}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{.9\textwidth}{!}{\input{closeness_topics_graphs.tex}}
\end{center}
...
\begin{table}[!hbtp]
    ...
    \input{cumulative_graphs_table.tex}}
...
\begin{table}[!hbtp]
    \centering
    \resizebox{.8\textwidth}{!}{
    \input{cumulative_clusters_table.tex}}
