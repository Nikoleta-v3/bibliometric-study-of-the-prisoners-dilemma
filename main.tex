...
This confirms the result that the most benefiting authors from their position in
the co-authorship network are authors from the main cluster of \(G\).
...
dynamics and authors are more likely to gain from their connections,
