...
There are five different APIs implemented within project~\cite{nikoleta_2017}.
These five APIs correspond to four prominent publishers of the field and a
preprint server:
...
The specific APIs were choosen to be implemented not only because they correspond
to prominent publishers, but also because they allow for free use of their APIs
and free collection of their data.
For a given API,~\cite{nikoleta_2017} allows users to collect articles by simple
specifying search terms and search fields. Articles for which any of the terms:
...
other terms that have been used as well, such as donation game. The results of
