...
natural selection procedure. Four different strategies strategies have a non zero
probability of remaining in the final population, Defector, Alternator, TitForTat
and Grudger. In~\cite{Axelrod1984},the results showed that in a homogeneous population
of Tit for Tat invasion by mutant strategies was not successful.
