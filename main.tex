...
Following the literature review we conducted in Section~\ref{},
...
collection is covered, followed by a preliminary analysis of the data in Section
\ref{section:preliminary_analysis}. In Section
\ref{section:co_authorship_analysis} we describe how authors relationships are
analysed graph theoretically to ascertain the level of collaborative nature
of the field and identify influence. This will be done relative to:
...
Finally in Section, we present the results of our analysis.
...
the preprint version of an articles (collected from arXiv) were dropped.
...
given byTable~\ref{table:forecast}. Thought the time series has indicated a slight
...
\begin{figure}
    ...
    %\caption{Time series of main data set and the rolling average.}\label{fig:fitting}
\end{figure}
...
\begin{table}
    \resizebox{\textwidth}{!}{\begin{tabular}{lccccccccc}
        \toprule
        Data Set & Num. Articles & Num. Authors & Nature (\%) & IEEE (\%) & PLOS (\%)& Springer (\%)& 
        arXiv (\%)& Overall Av. publication \\
        \midrule
        Prisoner's Dilemma & 3637 & \authors & 17.10 & 8.74 & 11.44 & 8.96  & 51.31 & 62 \\
        Auction Games      & 1386 & 1041     & 13.92 & 0.72 & -     & 65.51 & 19.84 & 29 \\
        Price of Anarchy   &  432 &  367     & 48.38 &    - & -     & 32.18 & 19.44 & 9 \\
        \bottomrule
        \end{tabular}}
        \caption{Measures of all three data sets.}
\end{table}
...
\subsection{Methodology}\label{section:co_authorship_analysis}
