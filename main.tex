...
Regarding between centrality, none of the three distribution is normally related.
The medians of the distributions are compared and found to be statistically different
based on a Kruskal Wallis test.
    \item All three distributions are skewed to the
    left, very close to zero. This imply that in all three networks, none
    of the authors gain much from being in the networks.
\end{itemize}

\begin{itemize}
    \item None of the
    
    For all three networks betweenness centrality is very skewed to the left
