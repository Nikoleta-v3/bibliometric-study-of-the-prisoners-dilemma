...
Following the chronological literature review we conducted in Section~ref{},
...
\ref{section:co_authorship_analysis} we described how the author relationships will be analysed graph
...
A series of search terms were used to identify relevant articles. Articles for which
any of these terms existed within the title, the abstract or the text are included
in the analysis. The terms used to collect the main data set were,
