...
In the section of the paper it was described how insights on the research on the
...
Furthermore, the number of articles and their provenance over the years was
reviewed. The number of articles appears to be increasing after 2000. That could
be because most of the journals used for data collection are either recent or
focused on computing/engineering sciences that have been used in the field mainly
after 2000.
...
provides several interesting findings. The connection have been examined using
network theory methods. 

The aim of the network analysis has been to research how collaborative the field
of the prisoner's dilemma is. Furthermore, the crucial authors of the network
were identifies and provide some insights of the partnerships of well known
authors and their topic of research.

The connectivity of the network was studied using several different measures.
In order to have an objective insight two other topics were considered as 
separate networks. The topics have been the price of anarchy and auction games.
The results have shown that the connectivity of all three
networks have been similar. Thus, the prisoner's dilemma is neither more or
less collaborative than these fields. 

However, the historical progress of the authorship is very different between the
fields. Auction games have been attracting more authors and collaborations
as time progresses. The price of anarchy is a new field that attracted a large
number of authors after 2004. The prisoner's dilemma seems to be a more
complicated, having a sudden decrease in 1960 and a sudden increase in 1970.

Those this could be due the bias that this analysis suffers, which is that only
5 journals are considered. 

Furthermore, there has been some difference  in the centrality of the networks. 
Further study can be performed to understand why there is indeed significant
difference in the centrality. 

An interpretation, based on the sub graphs study, is that the main centrality of
the network is due a single large clique. This could differ in the other fields were
several central authors that have managed to connect the overall network more.
...
to research as to whose work to follow next. Nevertheless, only a small number
