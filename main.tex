...
LDA maps every paper to a vector space of dimension of topics. In the case
...
seem to any given topic more or less in fashion}.
...
But how does this compare to other fields? Two more data sets for the topics
...
publication on the topic being~\cite{Koutsoupias1999} in 1999. This examples the
...
days. Overall, the an author in the PD has on average more collaborators
and there are less isolated authors compared to an other well established game
theoretic field. These results seem to indicate that the PD is a collaborative
field.
...
of both Price of Anarchy and Auction game also have high modularity, and
...
evolutionary dynamics on networks indicates that publishing in the specific
...
publishing in evolutionary dynamics on networks. Thus, an author would be aim
