...
\subsection{Evolutionary Dynamics (1987-1992)}
...
% In research years the study of the prisoners' dilemma still goes on and papers
% are being published. Several areas are still not fully explore. several varianits
% adn strategies are keep coming and applications.

% Thugh in this work the applications of such studies were nott fully higlter
% the preisoenr dilemma has fund it eay to cancer rease and cell~\cite{} study the.

% Spatial studies and the search of rules that can define when copperation does
% emerge in structure d poluulations is stilla hot tpoic.@zic wrote and article
% that higlighted the importnant of answering such wuirestion.

% New startgies and ways of research are still being developed~\cite{}.
