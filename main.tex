...
\begin{itemize}
    \item Other sub fields of game theory: the price of anarchy and auction games. %TODO: add generic reference for each
...
%TODO text example of url/message/request
...
%TODO: reference about the format.
...
%TODO cite Arcas and version etc. in zenodo and reference.
...
server.%TODO: add arxiv citation.
...
\manual_entries were manually added to the dataset throughout the writing of
Section~\ref{section:timetimeline}. The details of how many papers came from
...
topic for the longest time. The first papers respectively being~\cite{}.
...
It can been seen that IEEE contributed more
than 10 articles per year after 2002. Similarly, arXiv contributes with a large
number of papers with an increasing trend after 2000.
...
% this needs more.
publication on the topic in 2006~\cite{}. Finally Nature has a few publications over the
years. Nature was one of the early destinations for publications following the
pioneering paper by Axelrod~\cite{}. The first paper published was~\cite{} which
...
% TODO
Another leader in the field: Nowak (mentioned in Section~\ref{section:...} has
published various papers in Nature~\cite{}.
...
of sources. The overall rate at which papers have been written is ....
