...
Another common representation of the payoff matrix is given by~(\ref{eq:the_pd_payoffs}),
where \(b\) is the benefit of the altruistic behaviour and \(c\) is the cost and 
constrains (\ref{eq:constrain_one}) - (\ref{eq:constrain_two}) need to hold.
