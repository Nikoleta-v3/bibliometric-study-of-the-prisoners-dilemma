...
parameters had to be fitted. This was done using the Akaike Information Criterion
value. ARIMA also has been chosen because it can handle non stationary data.
The results of the forecast of the next following 10 years are given by Table.
